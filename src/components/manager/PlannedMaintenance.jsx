...
export default function PlannedMaintenance({ machines, regions = [], user, plannedWarningDays = 30, isArchive = false }) {
          ...
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 overflow-y-auto">
            <form onSubmit={handleSaveService} className="bg-white rounded-xl shadow-xl max-w-2xl w-full p-6 my-8">
              ...
              <div className="mb-6 bg-slate-50 p-4 rounded-lg border border-slate-200">
                ...
                <div className="mb-4">
  <select value={triggerType} onChange={e => setTriggerType(e.target.value)} className="w-full p-2 border border-slate-300 rounded outline-none bg-white">
    <option value="calendar">Kalendarzowy</option>
    <option value="hours">Roboczogodziny</option>
  ...
  return (
    <div className="space-y-6 flex flex-col">
      ...
      {/* Dodaj / Edytuj Plan Modal (Skopiowane) */}
        {/* Dodaj / Edytuj Plan Modal */}
        {isModalOpen && (
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 overflow-y-auto">
            <form onSubmit={handleSaveService} className="bg-white rounded-xl shadow-xl max-w-2xl w-full p-6 my-8">
